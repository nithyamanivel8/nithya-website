        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center md:justify-start w-full">
              <Button 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-8 shadow-lg hover:shadow-xl transition-all w-full sm:w-auto"
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-primary/30 hover:border-primary hover:bg-primary/5 rounded-full px-8 w-full sm:w-auto"
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-accent/50 hover:border-accent hover:bg-accent/10 rounded-full px-8 w-full sm:w-auto"
                onClick={() => {
                  const link = document.createElement('a');
                  link.href = '/NithyaManivel_Resume.pdf';
                  link.download = 'NithyaManivel_Resume.pdf';
                  link.click();
                }}
              >
            ...
            <Button
              variant="outline"
              size="lg"
              className="flex items-center gap-2 justify-center md:justify-start mt-4 border-2 border-secondary/50 hover:border-secondary hover:bg-secondary/10 rounded-full w-full sm:w-auto"
